...
/**
 * parseline - It tokenizes a line of text and stores it in line struct
 * @line: The struct containing line contents and line number
 * @buffer: The string of text read from script file
 *
 * Return: Nothing
 **/
...
/**
 * parsefile - It reads and parses file one line at a time
