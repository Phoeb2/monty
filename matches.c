...
/**
 * get_op_func - This function searches for a match between opcode and text
 * and returns the corresponding function
 * @line: The structure containing line contents and line number
 * @meta: The structure containing all the allocated memory
 *
