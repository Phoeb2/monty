...
/**
 * comment_check - It checks if the line is a comment
 * @line: The struct containing line contents and line number
 *
...
/**
 * argument_check - It verifies if an argument is valid
...
/**
 * push_check - It checks if push opcode is being used and sets global
 * argument variable if true
 * @line: The struct containing line contents and line number
 * @opcode: The opcode to compare
 * @meta: The struct containing all the allocated memory
 *
 * Return: Nothing.
 **/
